 ...
 * 2017-08-26T11:06:15.565-04:00
 * Generated source version: 3.0.4.redhat-621084
 * 
 */
@WebServiceClient(name = "ReportIncidentEndpointService", 
                  wsdlLocation = "file:/data/nfs/cases/active/AVIANCA-01917658/camelcxf-wss4j-interceptor-blueprint/camel-example-cxf-blueprint-producer/src/main/resources/META-INF/wsdl/report_incident_no_policy.wsdl",
...
public class ReportIncidentEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/data/nfs/cases/active/AVIANCA-01917658/camelcxf-wss4j-interceptor-blueprint/camel-example-cxf-blueprint-producer/src/main/resources/META-INF/wsdl/report_incident_no_policy.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReportIncidentEndpointService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/data/nfs/cases/active/AVIANCA-01917658/camelcxf-wss4j-interceptor-blueprint/camel-example-cxf-blueprint-producer/src/main/resources/META-INF/wsdl/report_incident_no_policy.wsdl");
        }
        WSDL_LOCATION = url;
    }
