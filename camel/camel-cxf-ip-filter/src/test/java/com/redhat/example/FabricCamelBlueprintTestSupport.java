...
public class FabricCamelBlueprintTestSupport extends CamelBlueprintTestSupport {

    protected static TestZookeeperServer server;
    protected static TestZookeeperClient client;

    private static volatile int port;
    private static final Logger LOG = LoggerFactory.getLogger(FabricCamelBlueprintTestSupport.class);
    ...
    public static void setupTestServer() throws Exception {
        port = AvailablePortFinder.getNextAvailable(2181);
