 ...
 * @author dhawkins
 */
public class AllowedTest extends FabricCamelBlueprintTestSupport {
    ...
    public void setUp() throws Exception {
        System.setProperty("ips.allowed", "127.0.0.1|10.0.0.213");
        System.setProperty("ips.denied", "10.0.0.1|10.0.0.2");
        super.setUp();
    }
    ...
    @Test
    public void routeAllowed() throws Exception {
        ...
        try {
            ...
            Assert.fail("Not expecting exception here");
            ex.printStackTrace();
        }
    }
