 ...
 * @author dhawkins
 */
public class NotAllowedTest extends FabricCamelBlueprintTestSupport {
    ...
    public void setUp() throws Exception {
        ...
        System.setProperty("ips.denied", "10.0.0.213");
        super.setUp();
    }
    ...
    @Test
    public void routeNotAllowed() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(401, ((HttpOperationFailedException)ex.getCause()).getStatusCode());
        }
    }
