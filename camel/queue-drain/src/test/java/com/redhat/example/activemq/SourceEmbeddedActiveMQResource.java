...
public class SourceEmbeddedActiveMQResource extends ExternalResource {
    ...
    public SourceEmbeddedActiveMQResource() {
    }

    public SourceEmbeddedActiveMQResource(boolean persistent) {
        this.persistent = persistent;
    }

    public SourceEmbeddedActiveMQResource(String brokerName) {
        this.brokerName = brokerName;
    }

    public SourceEmbeddedActiveMQResource(String brokerName, boolean persistent) {
        this.persistent = persistent;
        this.brokerName = brokerName;
    }
