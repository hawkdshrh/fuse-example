...
import com.redhat.example.activemq.DestEmbeddedActiveMQResource;
import com.redhat.example.activemq.SourceEmbeddedActiveMQResource;
...
public class JmsMessageMoverRouteBuilderTest extends CamelBlueprintTestSupport {
    ...
    protected String[] loadConfigAdminConfigurationFile() {
        return new String[]{"src/main/resources/repo/message.mover.cfg", "message.mover"};
    }
    ...
    @Rule
    public SourceEmbeddedActiveMQResource sourceBroker = new SourceEmbeddedActiveMQResource("localhost", false);
    
    @Rule
    public DestEmbeddedActiveMQResource destBroker = new DestEmbeddedActiveMQResource("localhost", false);

    String endpoint1 = "source://topic:t.Test1";
    String endpoint2 = "source://topic:t.Test2";

    @EndpointInject(uri = "mock://log://jms-message-mover-throughput")
    MockEndpoint target;
    ...
    public void testRouteBuilder() throws Exception {
        ...
        context.getRouteDefinitions().get(0).adviceWith(context, new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                interceptSendToEndpoint("log://jms-message-mover-throughput?level=DEBUG")
                        .skipSendToOriginalEndpoint()
                        .to("mock://log://jms-message-mover-throughput");
            }
        });
        ...
        context.getRouteDefinitions().get(1).adviceWith(context, new RouteBuilder() {
            ...
            public void configure() throws Exception {
                // intercept sending to mock:foo and do something else
                interceptSendToEndpoint("log://jms-jms-message-mover-throughput-throughput?level=DEBUG")
                        .skipSendToOriginalEndpoint()
                        .to("mock://log://jms-jms-message-mover-throughput-throughput");
            }
        });
