...
public class EmbeddedActiveMQResource extends ExternalResource {
    ...
    public EmbeddedActiveMQResource(boolean persistent) {
        this.persistent = persistent;
    }

    public EmbeddedActiveMQResource(String brokerName, String uri) {
        this.brokerName = brokerName;
        this.uri = uri;
    }

    public EmbeddedActiveMQResource(String brokerName, String uri, boolean persistent) {
        this.persistent = persistent;
        this.uri = uri;
        this.brokerName = brokerName;
    }
