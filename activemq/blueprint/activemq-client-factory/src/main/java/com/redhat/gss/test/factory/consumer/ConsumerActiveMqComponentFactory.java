package com.redhat.gss.test.factory.consumer;
...
public class ConsumerActiveMqComponentFactory implements CamelComponentFactory {
    ...
    public ConsumerActiveMqComponentFactory() {
