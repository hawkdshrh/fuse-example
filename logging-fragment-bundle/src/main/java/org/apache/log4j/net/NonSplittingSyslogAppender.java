 ...
 */
public class NonSplittingSyslogAppender extends AppenderSkeleton {
  ...
  public
  NonSplittingSyslogAppender() {
    this.initSyslogFacilityStr();
  }

  public
  NonSplittingSyslogAppender(Layout layout, int syslogFacility) {
    this.layout = layout;
  ...
  public
  NonSplittingSyslogAppender(Layout layout, String syslogHost, int syslogFacility) {
